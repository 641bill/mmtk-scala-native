...
#[allow(dead_code)]
pub const FEATURES: [&str; 3] = ["DEFAULT", "PERF_COUNTER", "PFM"];
#[doc=r#"The features as a comma-separated string."#]
#[allow(dead_code)]
pub const FEATURES_STR: &str = r"DEFAULT, PERF_COUNTER, PFM";
#[doc=r#"The output of `rustc -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.68.0 (2c8cc3432 2023-03-06)";
#[doc=r#"The output of `rustdoc -V`"#]
#[allow(dead_code)]
pub const RUSTDOC_VERSION: &str = r"rustdoc 1.68.0 (2c8cc3432 2023-03-06)";
...
#[allow(dead_code)]
pub const GIT_VERSION: Option<&str> = Some("lxr-2023-02-15-257-ge238316");
...
"#]
#[allow(dead_code)]
pub const GIT_HEAD_REF: Option<&str> = Some("refs/heads/lxr");
#[doc=r#"If the crate was compiled from within a git-repository, `GIT_COMMIT_HASH` contains HEAD's full commit SHA-1 hash."#]
#[allow(dead_code)]
pub const GIT_COMMIT_HASH: Option<&str> = Some("e2383164e377e4d95bf943b6a389e3b7e53e12ff");
